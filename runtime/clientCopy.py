...
def copyAssets(src, dst):
    ...
    if os.path.exists(dst):
        ...
        try:
            ...
            shutil.rmtree(dst)
            print("OK: Removed existing destination.")
        except Exception as e:
            print("ERROR: Failed to remove destination:", dst)
            print("Exception message:", str(e))
            sys.exit(1)
    else:
        print("Destination does not exist. Nothing to remove.")
